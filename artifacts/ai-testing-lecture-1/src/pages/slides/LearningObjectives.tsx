    ...
    <div style={wrap} dir={dir}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2vh' }}>
          <div style={card}>
            ...
            <div>
              ...
              >
                {t('Explain Non-Determinism', 'הסבר אי-דטרמיניזם')}
              </div>
          ...
          <div style={card}>
            ...
            <div>
              ...
              >
                {t('Choose the Right Evaluation Method', 'בחירת שיטת הערכה מתאימה')}
              </div>
              <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.4 }}>
                {t(
          ...
          <div style={card}>
            ...
            <div>
              ...
              >
                {t('Recognize Failure Before Users Do', 'זיהוי כשלים לפני המשתמשים')}
              </div>
              <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.4 }}>
                {t(
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: '1.2vw', fontWeight: 500, color: '#1E3A5F' }}>
                  {t('What AI testing changes, and why', 'מה בדיקות AI משנות, ולמה')}
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: '1.2vw', fontWeight: 500, color: '#1E3A5F' }}>
                  {t(
                    'Non-determinism and a new testing pyramid',
                    'אי-דטרמיניזם ופירמידת בדיקות חדשה',
                  )}
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: '1.2vw', fontWeight: 500, color: '#1E3A5F' }}>
                  {t(
                    'Golden datasets, judges, and similarity checks',
                    'Golden datasets, שופטים ובדיקות דמיון',
                  )}
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: '1.2vw', fontWeight: 500, color: '#1E3A5F' }}>
                  {t(
                    'Building and running your first test suite',
                    'בניה והרצה של חבילת הבדיקות הראשונה שלך',
                  )}
                </div>
              </div>
            </div>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '1vw' }}>
          ...
          <span>&bull;</span>
          <span>{t('Slide 2 of 22', 'שקופית 2 מתוך 22')}</span>
        </div>
      </div>
    </div>
  );
