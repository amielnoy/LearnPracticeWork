...
function Row({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6vh' }}>
      <div style={{ fontSize: '0.85vw', fontWeight: 700, letterSpacing: '0.08em', color: labelColor }}>
        {label}
      </div>
...
const ROW_COLORS = ['#2DD4BF', '#38BDF8', '#FBBF24', '#94A3B8'];

export default function WorkedExampleLlmAsJudge() {
    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '1vw' }}>
          ...
          <span>&bull;</span>
          <span>{t('Slide 13 of 22', 'שקופית 13 מתוך 22')}</span>
        </div>
      </div>
    </div>
  );
