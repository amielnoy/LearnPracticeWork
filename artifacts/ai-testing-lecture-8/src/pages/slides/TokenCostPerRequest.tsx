    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: '2vh', fontSize: '1vw', color: '#64748B', lineHeight: 1.5 }}>
            {t(
              'Track both sides. A verbose system prompt inflates input tokens on every request.',
              'עקוב אחר שני הצדדים. פרומפט מערכת מרובה מילים מנפח טוקני קלט בכל בקשה.',
            )}
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            {t('What to Measure per Request', 'מה למדוד לכל בקשה')}
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5vh' }}>
            ...
            >
              <div style={{ fontSize: '1.05vw', fontWeight: 600, color: '#1E3A5F' }}>
                {t('Prompt tokens', 'טוקני פרומפט')}
              </div>
              <div style={{ fontSize: '1.05vw', color: '#0D9488', fontWeight: 600 }}>
                {t('Input cost driver', 'מניע עלות קלט')}
              </div>
            </div>
            <div
              style={{
            ...
            >
              <div style={{ fontSize: '1.05vw', fontWeight: 600, color: '#1E3A5F' }}>
                {t('Completion tokens', 'טוקני השלמה')}
              </div>
              <div style={{ fontSize: '1.05vw', color: '#DC2626', fontWeight: 600 }}>
                {t('Output cost driver', 'מניע עלות פלט')}
              </div>
            </div>
            <div
              style={{
            ...
            >
              <div style={{ fontSize: '1.05vw', fontWeight: 600, color: '#1E3A5F' }}>
                {t('Total tokens', 'סך הטוקנים')}
              </div>
              <div style={{ fontSize: '1.05vw', color: '#475569' }}>
                {t('Rate limit consumption', 'צריכת מגבלת קצב')}
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <div style={{ fontSize: '1.05vw', fontWeight: 600, color: '#1E3A5F' }}>
                {t('USD cost per call', 'עלות USD לקריאה')}
              </div>
              <div style={{ fontSize: '1.05vw', color: '#475569' }}>
                {t('Aggregate to daily/monthly', 'צבור ליומי/חודשי')}
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            {t('Budget target', 'יעד תקציב')}
          </div>
          <div style={{ fontSize: '1vw', color: '#1E3A5F', lineHeight: 1.5 }}>
            {t(
              'Set a per-feature cost budget (e.g. $0.003/request) and alert when weekly average exceeds it by 15%.',
              'הגדר תקציב עלות לכל תכונה (למשל $0.003/בקשה) והתריע כאשר הממוצע השבועי עולה עליו ב-15%.',
            )}
          </div>
        </div>
      </div>
