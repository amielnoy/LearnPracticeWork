      ...
      >
        ...
        <div style={{ display: 'flex', gap: '2vw' }}>
          ...
          >
            ...
            <div style={{ fontSize: '0.95vw', color: '#64748B' }}>
              {t('Typical LLM p50 latency', 'זמן אחזור p50 טיפוסי של LLM')}
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ fontSize: '0.95vw', color: '#64748B' }}>
              {t('p99 vs p50 spread', 'פיזור p99 לעומת p50')}
            </div>
          </div>
        </div>
      </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5vh' }}>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                >
                  {t('Latency variance', 'שונות זמן אחזור')}
                </div>
                <div style={{ fontSize: '0.95vw', color: '#64748B', lineHeight: 1.4 }}>
                  {t(
                    'Response time swings with input tokens, server load, and model version.',
                    'זמן תגובה משתנה עם טוקני קלט, עומס שרת וגרסת מודל.',
                  )}
                </div>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                >
                  {t('Token streaming', 'זרימת טוקנים')}
                </div>
                <div style={{ fontSize: '0.95vw', color: '#64748B', lineHeight: 1.4 }}>
                  {t(
                    'Time-to-first-token matters as much as total completion time.',
                    'זמן לטוקן הראשון חשוב כמו זמן השלמה כולל.',
                  )}
                </div>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                >
                  {t('Cold starts', 'Cold starts')}
                </div>
                <div style={{ fontSize: '0.95vw', color: '#64748B', lineHeight: 1.4 }}>
                  {t(
                    'First request after idle can be 5–10x slower than steady state.',
                    'הבקשה הראשונה לאחר סרלנות יכולה להיות 5–10x איטית יותר.',
                  )}
                </div>
              </div>
            </div>
