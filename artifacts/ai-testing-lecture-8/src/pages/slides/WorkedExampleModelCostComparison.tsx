      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1vh' }}>
          ...
          >
            ...
            >
              model, avg_cost, avg_tokens,
              <br />
              sorted by avg_cost asc
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={codeBlock}>
          ...
          <div style={{ marginTop: '1.5vh' }}>
            ...
            <span style={{ color: '#F472B6' }}>costByModel</span>() {'{'}
          </div>
          ...
          <div style={{ paddingLeft: '4vw' }}>
            .rpc(<span style={{ color: '#86EFAC' }}>'avg_cost_by_model'</span>, {'{'}
          </div>
          <div style={{ paddingLeft: '6vw' }}>
            feature_name: <span style={{ color: '#86EFAC' }}>'chat'</span>,
          </div>
          <div style={{ paddingLeft: '6vw' }}>
            days_back: <span style={{ color: '#FDA4AF' }}>7</span>,
          </div>
