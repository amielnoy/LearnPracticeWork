    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2vh' }}>
          ...
          >
            {t('What to hold constant:', 'מה להשאיר קבוע:')}
          </div>
          <div style={{ display: 'flex', gap: '1vw', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: '1.05vw', color: '#475569' }}>
              {t('Same prompt text and system prompt', 'אותו טקסט פרומפט ופרומפט מערכת')}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1vw', alignItems: 'center' }}>
            <div
            ...
            />
            <div style={{ fontSize: '1.05vw', color: '#475569' }}>
              {t('Same model version and parameter settings', 'אותה גרסת מודל והגדרות פרמטרים')}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1vw', alignItems: 'center' }}>
            <div
            ...
            <div style={{ fontSize: '1.05vw', color: '#475569' }}>
              {t(
                'Same geographic region for your test runner',
                'אותו אזור גיאוגרפי לרץ הבדיקות שלך',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1vw', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: '1.05vw', color: '#475569' }}>
              {t(
                'Same time of day (avoid off-peak skew)',
                'אותה שעה ביום (הימנע מהטיית שעות שקטות)',
              )}
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            {t('Example Benchmark Results', "תוצאות בנצ'מרק לדוגמה")}
          </div>
          <div
            style={{
              display: 'grid',
        ...
        >
          <div style={{ fontSize: '1vw', color: '#1E3A5F', lineHeight: 1.5 }}>
            {t(
              'Values are illustrative. Run your own benchmarks with your production prompt distribution.',
              "הערכים הם להמחשה. הרץ את הבנצ'מרקים שלך עם הפיזור של הפרומפטים שלך בייצור.",
            )}
          </div>
        </div>
      </div>
