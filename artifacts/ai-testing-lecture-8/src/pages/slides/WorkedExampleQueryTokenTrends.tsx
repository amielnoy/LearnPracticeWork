      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={codeBlock}>
          ...
          <div style={{ marginTop: '1.5vh' }}>
            ...
            <span style={{ color: '#F472B6' }}>weeklyTokenCostTrends</span>() {'{'}
          </div>
          <div style={{ paddingLeft: '2vw' }}>
            <span style={{ color: '#94A3B8' }}>// Use Supabase RPC for date_trunc aggregation</span>
          </div>
          <div style={{ paddingLeft: '2vw' }}>
            <span style={{ color: '#7DD3FC' }}>const</span> {'{ data, error }'} ={' '}
            <span style={{ color: '#7DD3FC' }}>await</span> sb
          </div>
          <div style={{ paddingLeft: '4vw' }}>
            .rpc(<span style={{ color: '#86EFAC' }}>'weekly_cost_trends'</span>, {'{'}
          </div>
          <div style={{ paddingLeft: '6vw' }}>
            since_days: <span style={{ color: '#FDA4AF' }}>30</span>,
          </div>
          <div style={{ paddingLeft: '4vw' }}>{'}'});</div>
          <div style={{ paddingLeft: '2vw', marginTop: '1vh' }}>
            <span style={{ color: '#7DD3FC' }}>if</span> (error){' '}
            <span style={{ color: '#7DD3FC' }}>throw</span> error;
          </div>
          ...
          <div>{'}'}</div>
          <div style={{ marginTop: '2vh', color: '#64748B', fontSize: '0.9vw' }}>
            -- SQL function in Supabase (migration)
          </div>
          <div>
            <span style={{ color: '#A78BFA' }}>CREATE OR REPLACE FUNCTION</span> weekly_cost_trends(
          </div>
          <div style={{ paddingLeft: '2vw' }}>
            since_days <span style={{ color: '#7DD3FC' }}>INT</span>
          </div>
          <div>
            ) <span style={{ color: '#A78BFA' }}>RETURNS TABLE</span>(
          </div>
          <div style={{ paddingLeft: '2vw' }}>
            week <span style={{ color: '#7DD3FC' }}>TIMESTAMPTZ</span>, feature{' '}
            <span style={{ color: '#7DD3FC' }}>TEXT</span>,
          </div>
          <div style={{ paddingLeft: '2vw' }}>
            avg_cost_usd <span style={{ color: '#7DD3FC' }}>NUMERIC</span>
          </div>
          <div>
