    ...
    <div style={wrap} dir={dir}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr', gap: '1vw' }}>
        ...
        <div style={{ background: '#1E3A5F', borderRadius: '0.8vw 0.8vw 0 0', padding: '2vh 2vw' }}>
          <div style={{ fontSize: '1.1vw', fontWeight: 700, color: 'rgba(255,255,255,0.6)' }}>
            {t('Dimension', 'ממד')}
          </div>
        </div>
        <div
        ...
        <div style={{ background: '#0D9488', borderRadius: '0.8vw 0.8vw 0 0', padding: '2vh 2vw' }}>
          <div style={{ fontSize: '1.1vw', fontWeight: 700, color: '#FFFFFF' }}>
            {t('LLM/AI API', 'API של LLM/AI')}
          </div>
        </div>

        {/* Row 1 */}
        <div
          style={{ background: '#FFFFFF', padding: '2vh 2vw', borderBottom: '1px solid #E2E8F0' }}
        >
          <div style={{ fontSize: '1.05vw', fontWeight: 600, color: '#1E3A5F' }}>
            {t('Typical latency', 'זמן אחזור טיפוסי')}
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div style={{ fontSize: '1.05vw', fontWeight: 600, color: '#1E3A5F' }}>
            {t('Response variance (p99/p50)', 'שונות תגובה (p99/p50)')}
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div style={{ fontSize: '1.05vw', color: '#475569' }}>
            {t('Fixed schema, bytes', 'סכמה קבועה, בייטים')}
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div style={{ fontSize: '1.05vw', color: '#0F766E', fontWeight: 600 }}>
            {t('Variable tokens (cost driver)', 'טוקנים משתנים (מניע עלות)')}
          </div>
        </div>
        ...
        <div
          style={{
            ...
            padding: '2vh 2vw',
            borderLeft: '1px solid #CCFBF1',
            borderRadius: '0 0 0.8vw 0',
          }}
        >
          <div style={{ fontSize: '1.05vw', color: '#0F766E', fontWeight: 600 }}>
            {t('Per-token metered billing', 'חיוב מדוד לפי טוקן')}
          </div>
        </div>
      </div>
