  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t('Putting It All Together', 'חיבור הכל ביחד')}
        </h1>
        <p
          style={{
            fontSize: '1.5vw',
        ...
        >
          {t(
            'A full team rollout plan, roles and responsibilities, the AI testing maturity model, and a worked end-to-end strategy walkthrough.',
            'תוכנית גלגול מלאה לצוות, תפקידים ואחריות, מודל בגרות בדיקות ה-AI וסקירה מלאה של הגרעין-לסיום.',
          )}
        </p>
        <div
          style={{
