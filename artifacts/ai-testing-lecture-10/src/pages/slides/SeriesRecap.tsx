    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4vh' }}>
          ...
          >
            {t(
              'L1–L3: Foundations — what, why, and how to evaluate LLM outputs',
              'הרצאות 1–3: יסודות — מה, מדוע וכיצד להעריך פלטי LLM',
            )}
          </div>
          <div
            style={{
          ...
          >
            {t(
              'L4–L5: Automation — Playwright, API testing, and harness design',
              'הרצאות 4–5: אוטומציה — Playwright, בדיקות API ועיצוב רתמה',
            )}
          </div>
          <div
            style={{
          ...
          >
            {t(
              'L6: CI/CD pipelines for AI test suites',
              'הרצאה 6: צינורות CI/CD לחבילות בדיקות AI',
            )}
          </div>
          <div
            style={{
          ...
          >
            {t(
              'L7–L8: Security and performance testing for AI features',
              'הרצאות 7–8: בדיקות אבטחה וביצועים לתכונות AI',
            )}
          </div>
          <div
            style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2vh' }}>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div style={{ fontSize: '1.1vw', color: 'rgba(255,255,255,0.8)', lineHeight: 1.45 }}>
                {t(
                  'Tests exist but no one knows which ones matter',
                  'בדיקות קיימות אבל אף אחד לא יודע אילו חשובות',
                )}
              </div>
            </div>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div style={{ fontSize: '1.1vw', color: 'rgba(255,255,255,0.8)', lineHeight: 1.45 }}>
                {t(
                  'Coverage is accidental — gaps appear at the worst moments',
                  'כיסוי מקרי — פערים מופיעים ברגעים הגרועים ביותר',
                )}
              </div>
            </div>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div style={{ fontSize: '1.1vw', color: 'rgba(255,255,255,0.8)', lineHeight: 1.45 }}>
                {t(
                  'Metrics exist in silos — no single view of quality',
                  'מדדים קיימים בבידוד — אין תצוגה אחת של איכות',
                )}
              </div>
            </div>
            <div style={{ display: 'flex', gap: '1.5vw', alignItems: 'flex-start' }}>
              ...
              <div style={{ fontSize: '1.1vw', color: 'rgba(255,255,255,0.8)', lineHeight: 1.45 }}>
                {t(
                  'Model upgrades break things invisibly',
                  'שדרוגי מודל שוברים דברים באופן בלתי נראה',
                )}
              </div>
            </div>
          </div>
