    ...
    <div style={wrap} dir={dir}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: isHe ? 'right' : 'left' }}>
        ...
        <p style={{ fontSize: '1.5vw', color: 'rgba(255,255,255,0.7)', lineHeight: 1.5, maxWidth: '55vw' }}>
          {t(
            'Accuracy is not enough. Combining quality, cost, latency, and security into a single scorecard that decision-makers can act on.',
            'דיוק לא מספיק. שילוב איכות, עלות, זמן אחזור ואבטחה לכרטיס ניקוד אחד שמקבלי ההחלטות יכולים לפעול על פיו.',
          )}
        </p>
