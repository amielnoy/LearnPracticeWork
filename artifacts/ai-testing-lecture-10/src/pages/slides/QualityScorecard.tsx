      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5vh' }}>
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: '1.1vw', textAlign: 'center', color: '#059669', fontWeight: 600 }}
            >
              88
            </div>
            <div
            ...
            <div
              style={{ fontSize: '1.1vw', textAlign: 'center', color: '#D97706', fontWeight: 600 }}
            >
              74
            </div>
            <div
            ...
            <div
              style={{ fontSize: '1.3vw', textAlign: 'center', color: '#059669', fontWeight: 800 }}
            >
              89
            </div>
            ...
            <div
              style={{ fontSize: '1.1vw', textAlign: 'center', color: '#DC2626', fontWeight: 600 }}
            >
              0
            </div>
            <div
              style={{ fontSize: '1.3vw', textAlign: 'center', color: '#DC2626', fontWeight: 800 }}
            >
              63
            </div>
            <div style={{ textAlign: 'center' }}>
        ...
        >
          <div style={{ fontSize: '1.1vw', color: '#0D9488', fontWeight: 600 }}>
            {t(
              'Overall score = weighted average. Security = hard gate — any critical finding sets overall to 0 regardless of other scores.',
              'ציון כולל = ממוצע משוקלל. אבטחה = שער קשיח — כל ממצא קריטי מגדיר את הכולל ל-0 ללא קשר לציונים אחרים.',
            )}
          </div>
        </div>
      </div>
