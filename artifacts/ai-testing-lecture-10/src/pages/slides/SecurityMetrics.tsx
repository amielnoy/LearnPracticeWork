        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5vh' }}>
          ...
          >
            <div style={{ fontSize: '1.1vw', fontWeight: 600, color: '#1E3A5F' }}>
              {t('Prompt injection resistance', 'עמידות להזרקת פרומפט')}
            </div>
            <div style={{ fontSize: '1vw', color: '#DC2626', fontWeight: 600 }}>
              {t('Must be 100%', 'חייב להיות 100%')}
            </div>
          </div>
          <div
            style={{
          ...
          >
            <div style={{ fontSize: '1.1vw', fontWeight: 600, color: '#1E3A5F' }}>
              {t('PII leak rate in outputs', 'שיעור דליפת PII בפלטים')}
            </div>
            <div style={{ fontSize: '1vw', color: '#DC2626', fontWeight: 600 }}>
              {t('Must be 0%', 'חייב להיות 0%')}
            </div>
          </div>
          <div
            style={{
          ...
          >
            <div style={{ fontSize: '1.1vw', fontWeight: 600, color: '#1E3A5F' }}>
              {t('Harmful content block rate', 'שיעור חסימת תוכן מזיק')}
            </div>
            <div style={{ fontSize: '1vw', color: '#DC2626', fontWeight: 600 }}>
              {t('Must be 100%', 'חייב להיות 100%')}
            </div>
          ...
          >
            <div style={{ fontSize: '1.1vw', fontWeight: 600, color: '#1E3A5F' }}>
              {t('Critical security findings', 'ממצאי אבטחה קריטיים')}
            </div>
            <div style={{ fontSize: '1vw', color: '#DC2626', fontWeight: 600 }}>
              {t('Must be 0', 'חייב להיות 0')}
            </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                {t('Binary gate, not a score', 'שער בינארי, לא ציון')}
              </div>
              <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.5 }}>
                {t(
                  'A single critical security finding sets the security column to 0 regardless of all other scores. No averaging past a hard stop.',
                  'ממצא אבטחה קריטי אחד מגדיר את עמודת האבטחה ל-0 ללא קשר לכל הציונים האחרים.',
                )}
              </div>
            </div>
            <div>
              ...
              >
                {t('Store findings in Supabase', 'שמור ממצאים ב-Supabase')}
              </div>
              <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.5 }}>
                {t(
                  'Each security probe result is written to a security_findings table for audit trail and trend analysis.',
                  'כל תוצאת בדיקת אבטחה נכתבת לטבלת security_findings לנתיב ביקורת וניתוח מגמות.',
                )}
              </div>
            </div>
          </div>
