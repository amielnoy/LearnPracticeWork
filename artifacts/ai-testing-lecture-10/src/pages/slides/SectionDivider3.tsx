    ...
    <div style={wrap} dir={dir}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: isHe ? 'right' : 'left' }}>
        ...
        <h1 style={{ fontSize: '5vw', fontWeight: 800, margin: '0 0 3vh 0', lineHeight: 1.05, letterSpacing: '-0.02em', color: '#FAFBFC' }}>
          {t('Reporting & Continuous Improvement', 'דיווח ושיפור מתמיד')}
        </h1>
        <p style={{ fontSize: '1.5vw', color: 'rgba(255,255,255,0.7)', lineHeight: 1.5, maxWidth: '55vw' }}>
          {t(
            'Dashboards for stakeholders, retro cadence, keeping eval sets current, and tracking model changes before they surprise you.',
            'לוחות מחוונים לבעלי עניין, קצב רטרוספקטיבה, עדכון ערכות הערכה ומעקב אחר שינויי מודל לפני שיפתיעו אתכם.',
          )}
        </p>
