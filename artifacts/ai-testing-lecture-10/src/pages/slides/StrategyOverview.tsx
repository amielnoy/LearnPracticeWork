        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.45 }}>
              {t(
                'Which features, paths, and risk areas have tests — and which do not.',
                'אילו תכונות, נתיבים ואזורי סיכון נבדקים — ואילו לא.',
              )}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.45 }}>
              {t(
                'Unit, integration, system, and production monitoring — each layer has a distinct job.',
                'יחידה, אינטגרציה, מערכת וניטור ייצור — לכל שכבה תפקיד ייחודי.',
              )}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.45 }}>
              {t(
                'Accuracy, cost, latency, and security — combined into a single scorecard per release.',
                'דיוק, עלות, זמן אחזור ואבטחה — משולבים בכרטיס ניקוד אחד לכל גרסה.',
              )}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.45 }}>
              {t(
                'Stakeholder dashboards, retro cadence, and keeping eval sets current with model changes.',
                'לוחות מחוונים לבעלי עניין, קצב רטרוספקטיבה ועדכון ערכות הערכה.',
              )}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.45 }}>
              {t(
                'Roles, responsibilities, and a maturity model to track how the organization grows.',
                'תפקידים, אחריות ומודל בגרות למעקב אחר צמיחת הארגון.',
              )}
            </div>
          </div>
        </div>
