  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t('Testing LLM Outputs', 'בדיקת פלטי LLM')}
        </h1>
        <p
          style={{
            fontSize: '1.5vw',
        ...
        <div style={{ display: 'flex', gap: '2vw' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '1vw' }}>
              <div style={{ fontSize: '3.5vw', fontWeight: 700, color: '#1E3A5F' }}>03</div>
              <div
                style={{
                  fontSize: '1vw',
                  fontWeight: 600,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {t('Safety & Structure', 'בטיחות ומבנה')}
              </div>
            </div>
            <div
              style={{
