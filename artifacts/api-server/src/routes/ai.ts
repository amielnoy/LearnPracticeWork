...
const DEFAULT_MODEL = configuredDefaultModel && ALLOWED_GEMINI_MODELS.includes(
  configuredDefaultModel as (typeof ALLOWED_GEMINI_MODELS)[number],
)
...
const GenerateRequestSchema = z.object({
  ...
  const inputChars = value.system.length
...
router.post('/ai/generate', burstLimiter, dailyQuota, exposeDailyQuota, async (req, res): Promise<void> => {
