          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.5 }}>
                {t(
                  'Longer CI, maintenance burden, and false confidence that "600 tests" means good coverage when 200 test the same path.',
                  'CI ארוך יותר, נטל תחזוקה, וביטחון שגוי ש-"600 בדיקות" פירושן כיסוי טוב כשאר 200 בודקות את אותו הנתיב.',
                )}
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5vh' }}>
              ...
              >
                ...
                >
                  {t('Coverage diff', 'diff כיסוי')}
                </div>
                <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.4 }}>
                  {t(
                    'Run coverage before and after each generated test. Reject tests that add zero new lines.',
                    'הרץ כיסוי לפני ואחרי כל בדיקה שנוצרה. דחה בדיקות שלא מוסיפות שורות חדשות.',
                  )}
                </div>
              </div>
              <div
              ...
              >
                ...
                <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.4 }}>
                  {t(
                    'Embed test descriptions; cluster by cosine similarity. Flag pairs above 0.9 threshold.',
                    'הטמע תיאורי בדיקות; קבץ לפי דמיון קוסינוס. סמן זוגות מעל סף 0.9.',
                  )}
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  {t('Mutation testing', 'בדיקת מוטציה')}
                </div>
                <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.4 }}>
                  {t(
                    'Mutants that are not killed by any generated test reveal gaps; tests that kill no mutants are candidates for removal.',
                    'מוטנטים שלא נהרגים על ידי אף בדיקה שנוצרה חושפים פערים; בדיקות שלא הורגות מוטנטים הן מועמדות להסרה.',
                  )}
                </div>
              </div>
            </div>
