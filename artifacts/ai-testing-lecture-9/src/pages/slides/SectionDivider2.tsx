    ...
    <div style={wrap} dir={dir}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: isHe ? 'right' : 'left' }}>
        ...
        <p style={{ fontSize: '1.5vw', color: 'rgba(255,255,255,0.7)', lineHeight: 1.5, maxWidth: '55vw' }}>
          {t(
            'GitHub Copilot, Cursor, custom generation pipelines, and the prompt patterns that produce reliable tests rather than plausible-looking noise.',
            'GitHub Copilot, Cursor, צינורות יצירה מותאמים אישית ותבניות הפרומפט שמניבות בדיקות אמינות ולא רעש שנראה סביר.',
          )}
        </p>
