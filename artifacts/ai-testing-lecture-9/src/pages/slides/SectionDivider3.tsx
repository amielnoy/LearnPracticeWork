    ...
    <div style={wrap} dir={dir}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: isHe ? 'right' : 'left' }}>
        ...
        <p style={{ fontSize: '1.5vw', color: 'rgba(255,255,255,0.7)', lineHeight: 1.5, maxWidth: '55vw' }}>
          {t(
            'Reviewing AI-generated tests, detecting flakiness, pruning redundancy, and triaging failures with AI assistance.',
            'סקירת בדיקות שנוצרו על ידי AI, זיהוי חוסר יציבות, גיזום יתירות וסיווג כשלים בסיוע AI.',
          )}
        </p>
