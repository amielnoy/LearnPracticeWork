        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.6vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Hardcoded time.sleep() or Date.now() comparisons without mocking',
                'time.sleep() מקודד בצורה קשיחה או השוואות Date.now() ללא mock',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                ...
                'בדיקות שתלויות בסדר הביצוע (מצב משותף הניתן לשינוי)',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                ...
                'יצירת נתונים אקראית ללא זרעים קבועים',
              )}
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2vh' }}>
            <div>
              ...
              >
                {t('Run new tests 3x before merging', 'הרץ בדיקות חדשות 3 פעמים לפני מיזוג')}
              </div>
              <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.4 }}>
                {t(
                  'Any pass/fail variance marks the test as flaky and blocks it from the suite.',
                  'כל שונות pass/fail מסמנת את הבדיקה כלא-יציבה ומונעת כניסתה לחבילה.',
                )}
              </div>
            </div>
            ...
            <div>
              ...
              >
                {t('Static analysis pass before runtime', 'מעבר ניתוח סטטי לפני זמן ריצה')}
              </div>
              <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.4 }}>
                {t(
                  'Grep generated code for time.sleep, Date.now, Math.random without seed. Reject before CI runs.',
                  'חפש בקוד שנוצר time.sleep, Date.now, Math.random ללא seed. דחה לפני ריצת CI.',
                )}
              </div>
            </div>
            <div style={{ height: '1px', background: '#E2E8F0' }} />
            <div>
              ...
              >
                {t('Log flakiness verdicts in Supabase', 'רשום פסיקות חוסר יציבות ב-Supabase')}
              </div>
              <div style={{ fontSize: '1vw', color: '#475569', lineHeight: 1.4 }}>
                {t(
                  'Store generator_tool so you can compare Copilot vs. Cursor flakiness rates.',
                  'אחסן generator_tool כדי שתוכל להשוות שיעורי חוסר יציבות בין Copilot ל-Cursor.',
                )}
              </div>
            </div>
          </div>
