        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2vw' }}>
          <div style={card}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
              {t(
                'the model guesses at what you meant, and guesses differently each time',
                'המודל מנחש את כוונתכם, ומנחש אחרת בכל פעם',
              )}
            </div>
          </div>
          <div style={card}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
              {t(
                'buried conflicting rules that only surface under specific inputs',
                'כללים סותרים קבורים שצפים רק בקלטים ספציפיים',
              )}
            </div>
          </div>
          <div style={card}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
              {t(
                'the model slowly wanders from the requested schema over a long conversation',
                'המודל נודד בהדרגה מהסכימה המבוקשת לאורך שיחה ארוכה',
              )}
            </div>
          </div>
          <div style={card}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
              {t(
                'burying the actual instruction under too much reference material',
                'קבירת ההנחיה בפועל תחת יותר מדי חומר רקע',
              )}
            </div>
          </div>
        </div>
