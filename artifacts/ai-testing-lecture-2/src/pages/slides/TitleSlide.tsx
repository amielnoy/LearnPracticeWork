  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t('Prompt Engineering for Testers', 'הנדסת פרומפטים לבודקים')}
        </h1>
        <p
          style={{
            fontSize: '1.5vw',
        ...
        >
          {t(
            'How do you write a prompt so its output can actually be tested?',
            'כיצד כותבים פרומפט כך שהפלט שלו ניתן לבדיקה בפועל?',
          )}
        </p>
        ...
        <div style={{ display: 'flex', gap: '2vw' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '1vw' }}>
              <div style={{ fontSize: '3.5vw', fontWeight: 700, color: '#1E3A5F' }}>02</div>
              <div
                style={{
                  fontSize: '1vw',
                  fontWeight: 600,
