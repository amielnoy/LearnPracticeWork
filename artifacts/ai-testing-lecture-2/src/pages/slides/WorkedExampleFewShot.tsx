...
function Row({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5vh' }}>
      ...
      <div style={{ fontSize: '1vw', lineHeight: 1.5, color: '#E2E8F0' }}>{children}</div>
    </div>
  );
}

const ROW_COLORS = ['#2DD4BF', '#2DD4BF', '#38BDF8', '#FBBF24'];

export default function WorkedExampleFewShot() {
    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '1vw' }}>
          ...
          <span>&bull;</span>
          <span>{t('Slide 11 of 21', 'שקופית 11 מתוך 21')}</span>
        </div>
      </div>
    </div>
  );
