        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.6vh' }}>
          <div style={bulletRow}>
            ...
            <div style={{ fontSize: '1.3vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Treat prompts as code: store them in version control, not scattered in strings across the codebase',
                'התייחסו לפרומפטים כמו לקוד: שמרו אותם בבקרת גרסאות, לא מפוזרים כמחרוזות ברחבי הקוד',
              )}
            </div>
          </div>
          <div style={bulletRow}>
            ...
            <div style={{ fontSize: '1.3vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Parameterize the variable parts (user input, context) and keep the scaffold fixed and reviewable',
                'הפכו את החלקים המשתנים לפרמטרים (קלט משתמש, הקשר) ושמרו על השלד קבוע וניתן לסקירה',
              )}
            </div>
          </div>
          <div style={bulletRow}>
            ...
            <div style={{ fontSize: '1.3vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Tag a prompt version alongside the model version it was tuned against',
                'תייגו גרסת פרומפט יחד עם גרסת המודל שמולה היא כווננה',
              )}
            </div>
          </div>
          <div style={bulletRow}>
            ...
            <div style={{ fontSize: '1.3vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'A prompt change should trigger the same review and test run as any other code change',
                'שינוי בפרומפט צריך להפעיל את אותה סקירה והרצת בדיקות כמו כל שינוי קוד אחר',
              )}
            </div>
          </div>
        </div>
