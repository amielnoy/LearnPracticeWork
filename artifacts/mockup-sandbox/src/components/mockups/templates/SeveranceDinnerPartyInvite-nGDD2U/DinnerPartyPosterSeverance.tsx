...
export default function DinnerPartyPosterSeverance() {
  return (
    ...
    >
      ...
      <div
        className="absolute"
        style={{ inset: 22, border: `1px solid ${DEEP}`, pointerEvents: 'none' }}
      />
      <div
        className="absolute"
        style={{ inset: 28, border: `1px solid ${DEEP}`, opacity: 0.35, pointerEvents: 'none' }}
      />

      <div
        className="relative flex flex-col items-center w-full px-16 pt-16 pb-14"
        style={{ maxWidth: 800 }}
      >
        {/* department heading */}
        <div
        ...
        <div
          ...
          style={{ fontFamily: MONO, fontSize: 13, letterSpacing: 3, color: PINE }}
        >
        ...
        <div
          ...
          style={{ border: `1px solid ${DEEP}`, padding: 10, background: '#fff' }}
        >
        ...
        <div className="mt-9 w-full grid grid-cols-3 text-center" style={{ fontFamily: MONO }}>
          {[
            ...
            <div key={k} className="flex flex-col items-center gap-2 px-2">
              ...
              <span style={{ fontSize: 14, letterSpacing: 1, color: INKY, fontWeight: 600 }}>
                {v}
              </span>
            </div>
          ))}
        ...
        >
          Please enjoy each course equally. Guests are kindly reminded that the menu is mysterious
          and important. A music &amp; dance experience may be sanctioned, pending conduct.
        </p>
