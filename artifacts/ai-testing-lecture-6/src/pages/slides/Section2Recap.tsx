  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t('Flakiness Needs a Visible Process', 'חוסר יציבות דורש תהליך גלוי')}
        </h1>
        <p style={{ fontSize: '1.2vw', color: '#475569', margin: '0 0 3vh 0', lineHeight: 1.6 }}>
          {t(
            'A silent retry loop that hides real regressions is the most dangerous form of test debt. The tools exist to make flakiness visible and manageable.',
            'לולאת ניסיון חוזר שקטה המסתירה רגרסיות אמיתיות היא צורת חוב הבדיקות המסוכנת ביותר. הכלים קיימים להפוך חוסר יציבות לגלוי וניהולי.',
          )}
        </p>
        <div
          style={{
        ...
        >
          ...
          <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.5 }}>
            {t(
              'A test that needs a retry to pass is not a passing test. It is a signal. Treat it as one.',
              'בדיקה שצריכה ניסיון חוזר כדי לעבור אינה בדיקה עוברת. היא אות. התייחס אליה ככזו.',
            )}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        >
          ...
          >
            {t('Three Techniques', 'שלוש טכניקות')}
          </div>
          <div
          ...
          >
            ...
            >
              ...
              />
              <div style={{ fontSize: '1.2vw', fontWeight: 500, color: '#1E3A5F' }}>
                {t('Quarantine list with weekly review', 'רשימת בידוד עם סקירה שבועית')}
              </div>
            </div>
            <div
              style={{ display: 'flex', gap: '2vw', alignItems: 'center', position: 'relative', zIndex: 1 }}
