  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t(
            'By the end of this lecture you can design, operate, and tune a CI pipeline that runs AI tests reliably on every pull request.',
            'בסיום ההרצאה תוכלו לתכנן, להפעיל ולכוונן צינור CI שמריץ בדיקות AI באופן אמין בכל pull request.',
          )}
        </p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.6vh' }}>
          <div style={card}>
            ...
            >
              {t('Design a CI pipeline stage for AI tests', 'תכנון שלב CI לבדיקות AI')}
            </div>
          ...
          <div style={card}>
            ...
            >
              {t('Handle flaky AI test results', 'טיפול בתוצאות בדיקות AI לא יציבות')}
            </div>
            <div style={{ fontSize: '1vw', color: '#64748B', lineHeight: 1.4 }}>
              {t(
                'Flag flakiness visibly instead of hiding real bugs behind silent retries.',
                'סימון חוסר יציבות בצורה גלויה במקום להסתיר באגים אמיתיים מאחורי ניסיונות חוזרים שקטים.',
              )}
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '1.2vw', fontWeight: 500, color: '#1E3A5F' }}>
                {t('Build an LLM-as-judge merge gate', 'בניית שער מיזוג עם LLM כשופט')}
              </div>
            </div>
            <div
              style={{
