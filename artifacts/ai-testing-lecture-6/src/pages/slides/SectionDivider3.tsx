  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t(
            'A merge gate should be fast enough not to block developers and strict enough to actually catch quality regressions.',
            'שער מיזוג צריך להיות מהיר מספיק לא לחסום מפתחים ומחמיר מספיק לתפוס בפועל רגרסיות באיכות.',
          )}
        </p>
        <div
          style={{
