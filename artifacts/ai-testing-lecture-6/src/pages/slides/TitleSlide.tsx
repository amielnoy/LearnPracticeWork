  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t('CI/CD for AI Test Suites', 'CI/CD לחבילות בדיקות AI')}
        </h1>
        <p
          style={{
            fontSize: '1.4vw',
        ...
        >
          {t(
            'Running AI-powered tests reliably, quickly, and affordably inside a normal pull-request pipeline.',
            'הרצת בדיקות מבוססות AI באופן אמין, מהיר וחסכוני בתוך צינור pull request רגיל.',
          )}
        </p>
        ...
        <div style={{ display: 'flex', gap: '2vw' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '1vw' }}>
              <div style={{ fontSize: '3.5vw', fontWeight: 700, color: '#1E3A5F' }}>06</div>
              <div
                style={{
                  fontSize: '1vw',
                  fontWeight: 600,
