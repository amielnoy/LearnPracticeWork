    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Input guardrails block known attack patterns. Output filters catch what slips through — including data the model memorised.',
            'guardrail לקלטים חוסמים תבניות מתקפה ידועות. מסנני פלט תופסים מה שחולק — כולל נתונים שהמודל שינן.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Canary strings give you a measurable memorisation rate. If the rate creeps up after a re-train, stop and investigate before deploying.',
            'מחרוזות מלכודת נותנות לך שיעור שינון מדיד. אם השיעור עולה לאחר re-train, עצור וחקור לפני פריסה.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Audit tool scopes as part of every security review. An injected prompt can only cause damage if the tool it hijacks has the power to do harm.',
            'בצע ביקורת על היקפי כלים כחלק מכל סקירת אבטחה. prompt מוזרק יכול לגרום נזק רק אם לכלי שהוא חוטף יש כוח לגרום נזק.',
          )}
        </div>
      </div>
