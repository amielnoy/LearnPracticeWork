    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'The harness is infrastructure. The prompt library is where the security expertise lives. Invest in curating and refreshing the library regularly.',
            'המסגרת היא תשתית. ספריית ה-prompt היא המקום שבו מתגוררת מומחיות האבטחה. השקע בהרכבה ורענון הספרייה באופן קבוע.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Critical-only, LLM-judged security tests on every pull request. Full adversarial suite nightly. Never sacrifice speed for coverage on the PR path.',
            'בדיקות אבטחה קריטיות בלבד, שנשפטו על ידי LLM, בכל pull request. חבילה עוינת מלאה בלילה. לעולם אל תקריב מהירות לכיסוי בנתיב ה-PR.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Runbooks, breach notification timelines, and the incident scope query written in advance. When an incident happens, the query is already in your repo.',
            'ספרי הפעלה, לוחות זמנים להודעת פרצה ושאילתת היקף האירוע כתובים מראש. כשמתרחש אירוע, השאילתה כבר נמצאת ב-repo שלך.',
          )}
        </div>
      </div>
