        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5vh' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5vw' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('LLM generates raw response', 'LLM יוצר תגובה גולמית')}
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5vw' }}>
            <div
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Regex PII scrubber removes emails, phones, SSNs',
                'מסנן PII של Regex מסיר אימיילים, טלפונים, מספרי ביטוח לאומי',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5vw' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Content moderation API checks for policy violations',
                'API לבקרת תוכן בודק הפרות מדיניות',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5vw' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Filtered response returned to user', 'תגובה מסוננת מוחזרת למשתמש')}
            </div>
          </div>
        </div>
      </div>
