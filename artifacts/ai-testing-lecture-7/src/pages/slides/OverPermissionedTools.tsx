        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Write when only read is needed', 'כתיבה כשרק קריאה דרושה')}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            <div
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Access to all user data when only a subset is required',
                'גישה לכל נתוני המשתמש כשרק תת-קבוצה נדרשת',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'No approval gate before destructive actions',
                'אין שער אישור לפני פעולות הרסניות',
              )}
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Attempt to call write-scope tools via an injection prompt; assert they are refused',
                'נסה לקרוא לכלי write-scope דרך prompt הזרקה; ודא שהם נדחים',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Verify no tool call crosses user/tenant boundaries in multi-user apps',
                'ודא שאף קריאת כלי אינה חוצה גבולות משתמש/דייר באפליקציות רב-משתמש',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Check that destructive actions (delete, send) require explicit human confirmation',
                'בדוק שפעולות הרסניות (מחיקה, שליחה) דורשות אישור אנושי מפורש',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Audit tool scopes quarterly using the manifest in your function definitions',
                'בצע ביקורת על היקפי כלים רבעוני תוך שימוש במניפסט בהגדרות הפונקציות שלך',
              )}
            </div>
          </div>
        </div>
