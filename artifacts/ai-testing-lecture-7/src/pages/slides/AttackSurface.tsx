        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Prompt injection via user messages or tool results',
                'הזרקת הנחיות דרך הודעות משתמש או תוצאות כלים',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'PII leakage from training data or RAG retrieval',
                'דליפת PII מנתוני אימון או שליפת RAG',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Over-permissioned tool calls executing unsafe actions',
                'קריאות כלים בעלות הרשאת יתר המבצעות פעולות לא בטוחות',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Unlimited API token spend via crafted inputs',
                'הוצאות בלתי מוגבלות של API tokens דרך קלטים מכוונים',
              )}
            </div>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5vh 2vw' }}>
            ...
            >
              {t('LLM-powered', 'מבוססת LLM')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Fixed SQL queries', 'שאילתות SQL קבועות')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Dynamic prompt construction', 'בניית prompt דינמית')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Static output schemas', 'סכמות פלט סטטיות')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Unpredictable free text', 'טקסט חופשי בלתי צפוי')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Known code paths', 'נתיבי קוד ידועים')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Emergent reasoning paths', 'נתיבי הסקה אמרגנטיים')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t('Bounded resource cost', 'עלות משאבים חסומה')}
            </div>
            <div style={{ fontSize: '1.1vw', color: '#DC2626', lineHeight: 1.4 }}>
              {t('Unbounded token spend', 'הוצאות tokens בלתי מוגבלות')}
            </div>
          </div>
        </div>
      </div>
