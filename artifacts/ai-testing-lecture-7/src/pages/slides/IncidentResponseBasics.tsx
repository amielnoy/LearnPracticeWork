    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ fontSize: '1.05vw', color: '#475569', lineHeight: 1.4 }}>
          {t(
            'Rate-limit or disable the affected endpoint immediately. Do not wait for a fix.',
            'הגבל קצב או השבת את נקודת הקצה המושפעת מיד. אל תמתין לתיקון.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.05vw', color: '#475569', lineHeight: 1.4 }}>
          {t(
            'Query Supabase for all users who hit the vulnerable endpoint during the exposure window.',
            'שאל את Supabase לגבי כל המשתמשים שפגעו בנקודת הקצה הפגיעה במהלך חלון החשיפה.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.05vw', color: '#475569', lineHeight: 1.4 }}>
          {t(
            'Patch the guardrail, add the attack variant to the regression test suite, and re-run the full security suite.',
            'תקן את ה-guardrail, הוסף את גרסת המתקפה לחבילת בדיקות הרגרסיה, והרץ מחדש את כל חבילת האבטחה.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.05vw', color: '#475569', lineHeight: 1.4 }}>
          {t(
            "If PII was accessed, follow your jurisdiction's breach notification timeline. Silence is not a strategy.",
            'אם PII נגש, עקוב אחר לוח הזמנים של הודעת הפרצה בתחום השיפוט שלך. שתיקה אינה אסטרטגיה.',
          )}
        </div>
      </div>
