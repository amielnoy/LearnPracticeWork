        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Plant unique canary strings in fine-tuning data and query for them regularly',
                'שתול מחרוזות ייחודיות מלכודת בנתוני fine-tuning ושאל לגביהן באופן קבוע',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Measure memorisation rate: % of canaries returned verbatim over N attempts',
                'מדוד שיעור שינון: % של מלכודות שהוחזרו מילה במילה על פני N ניסיונות',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Fail the build if memorisation rate exceeds threshold (e.g. 0.1%)',
                'עצור את ה-build אם שיעור השינון חורג מסף (לדוגמה 0.1%)',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.1vw', color: '#1E3A5F', lineHeight: 1.4 }}>
              {t(
                'Apply differential privacy during fine-tuning to reduce memorisation risk',
                'החל פרטיות דיפרנציאלית במהלך fine-tuning להפחתת סיכון שינון',
              )}
            </div>
          </div>
        </div>
