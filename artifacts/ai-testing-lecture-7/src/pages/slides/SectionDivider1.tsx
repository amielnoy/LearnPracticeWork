  ...
  return (
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        >
          {t(
            'Direct injection, indirect injection, system prompt leakage, and jailbreaking \u2014 the techniques attackers use to hijack LLM behavior.',
            'הזרקה ישירה, עקיפה, דליפת system prompt ו-jailbreaking \u2014 הטכניקות שהתוקפים משתמשים בהן לחטיפת התנהגות LLM.',
          )}
        </p>
        <div
          style={{
