        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Find all users who interacted with the endpoint during the exposure window',
                'מצא את כל המשתמשים שאינטראקציה עם נקודת הקצה במהלך חלון החשיפה',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Identify any prompts that received a LEAKED verdict during that window',
                'זהה prompts שקיבלו פסיקת LEAKED במהלך החלון הזה',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: '#1E3A5F', lineHeight: 1.5 }}>
              {t(
                'Export user list for breach notification within regulatory deadline',
                'ייצא רשימת משתמשים להודעת פרצה בתוך המועד הרגולטורי',
              )}
            </div>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={codePanel}>
          ...
          <div style={{ fontSize: '1.05vw', color: '#E2E8F0', lineHeight: 1.7 }}>
            ...
            <br />
            {'  .lte("created_at", exposureEnd)'}
            <br />
            {'  .eq("endpoint", "/api/chat");'}
          </div>
          <div style={{ height: '1px', background: '#1E293B' }} />
          <div style={{ fontSize: '1.05vw', color: '#E2E8F0', lineHeight: 1.7 }}>
            {'// 2. Cross-reference with leaked prompts'}
            <br />
