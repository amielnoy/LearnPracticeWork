    ...
    <div style={wrap} dir={dir}>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Test direct, indirect, and system-prompt leakage vectors. Missing one class of attack is the same as testing nothing.',
            'בדוק וקטורים של הזרקה ישירה, עקיפה ודליפת system prompt. פספוס סוג אחד של מתקפה שווה לבדיקה של כלום.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'Every prompt needs an expected outcome: BLOCKED, ALLOWED, or FLAGGED. Without a verdict, you have no pass/fail signal.',
            'לכל prompt דרוש תוצאה צפויה: BLOCKED, ALLOWED, או FLAGGED. ללא פסיקה, אין לך אות עבר/נכשל.',
          )}
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: '1.1vw', color: '#475569', lineHeight: 1.5 }}>
          {t(
            'A single score is a snapshot. Trending the jailbreak-resistance score over builds turns security tests into a regression detector.',
            'ציון בודד הוא תמונת מצב. מעקב ציון העמידות ל-jailbreak לאורך builds הופך בדיקות אבטחה למזהה רגרסיה.',
          )}
        </div>
      </div>
