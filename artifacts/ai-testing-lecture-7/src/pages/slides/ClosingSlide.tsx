      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5vh' }}>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            />
            <div style={{ fontSize: '1.2vw', color: 'rgba(255,255,255,0.85)', lineHeight: 1.4 }}>
              {t(
                'Next: Lecture 08 — Performance Testing AI Features',
                'הבא: הרצאה 08 — בדיקות ביצועים לתכונות AI',
              )}
            </div>
          </div>
          <div style={{ display: 'flex', gap: '1.2vw', alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: '1.2vw', color: 'rgba(255,255,255,0.85)', lineHeight: 1.4 }}>
              {t(
                '10 Supabase-backed worked examples included in this lecture',
                '10 דוגמאות מעשיות מגובות ב-Supabase כלולות בהרצאה זו',
              )}
            </div>
          </div>
        </div>
            ...
            >
              <div
                style={{
                  fontSize: '1vw',
                  fontWeight: 700,
                  color: lec.current ? '#0D9488' : 'rgba(255,255,255,0.4)',
                  minWidth: '2.5vw',
                }}
              >
                {lec.num}
              ...
              <div
                style={{
                  fontSize: '1.05vw',
                  color: lec.current ? '#FAFBFC' : 'rgba(255,255,255,0.55)',
                  fontWeight: lec.current ? 600 : 400,
                }}
              >
                {t(lec.en, lec.he)}
              </div>
