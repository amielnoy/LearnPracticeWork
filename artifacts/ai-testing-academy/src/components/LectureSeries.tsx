  ...
  tracks: [
    ...
    },
    {
      ...
      lectures: [
        ...
        { num: 2, ready: true, title: 'AI in Network Security Monitoring', desc: 'Applying AI to traffic analysis and intrusion detection — spotting lateral movement and exfiltration patterns in network logs.', url: 'https://ml-gf56k78.gamma.site/' },
        { num: 3, ready: false, title: 'AI-Powered Threat Detection Basics', desc: 'How machine learning models flag suspicious activity, from rule-based detection to anomaly scoring, and where AI adds real value over static rules.' },
        { num: 4, ready: false, title: 'Phishing & Social Engineering Detection with AI', desc: 'Using AI to spot phishing emails, deepfake voice scams, and social engineering attempts before they reach end users.' },
        { num: 5, ready: false, title: 'Malware Analysis Using Machine Learning', desc: 'Classifying and clustering malware samples with ML models, and the basics of static vs. behavioral analysis pipelines.' },
  ...
  tracks: [
    ...
    },
    {
      ...
      lectures: [
        ...
        { num: 2, ready: true, title: 'AI בניטור אבטחת רשת', desc: 'הפעלת AI על ניתוח תעבורת רשת וזיהוי חדירות — איתור תבניות תנועה רוחבית והדלפת מידע ביומני רשת.', url: 'https://ml-gf56k78.gamma.site/' },
        { num: 3, ready: false, title: 'יסודות זיהוי איומים עם AI', desc: 'כיצד מודלים של למידת מכונה מזהים פעילות חשודה, מזיהוי מבוסס חוקים ועד ניקוד אנומליות, והיכן AI מוסיף ערך אמיתי מעבר לחוקים סטטיים.' },
        { num: 4, ready: false, title: 'זיהוי פישינג והנדסה חברתית עם AI', desc: 'שימוש ב-AI לזיהוי הודעות פישינג, הונאות קול מבוססות deepfake וניסיונות הנדסה חברתית לפני שהם מגיעים למשתמשי הקצה.' },
        { num: 5, ready: false, title: 'ניתוח תוכנות זדוניות באמצעות למידת מכונה', desc: 'סיווג וקיבוץ של דגימות תוכנה זדונית עם מודלי ML, ויסודות הניתוח הסטטי לעומת ההתנהגותי.' },
