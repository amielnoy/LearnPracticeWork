...
export const he: Locale = {
  ...
  resume: {
    ...
    tipsLead:
      'הטעות הכי גדולה שמחפשי עבודה עושים: לחשוב שאם הם מתאימים למשרה, המגייסים כבר יבינו את זה לבד. הם לא. תכתבו את זה במפורש.',
    doTitle: '✅ עשה',
    dontTitle: '🚫 אל תעשה',
    dos: [
      'תבינו את המשרה לעומק — מה באמת חשוב להם ומה הם מחפשים.',
      'דייקו את הטייטלים שלכם כך שיתאימו למה שהמגייסת מחפשת, לא רק למה שהיה כתוב לכם בחתימת המייל.',
      'שזרו בקובץ מילות מפתח מתוך המשרה עצמה, כדי לעבור את הסינון האוטומטי.',
      'הראו רצף תעסוקתי ברור והשלימו חורים בציר הזמן.',
      'לעסו טוב טוב את מה שעשיתם והאכילו בכפית את מי שקורא — אל תצפו שיחפשו את הניסיון הרלוונטי בין הבולטים.',
      'ודאו שבכל שורה רואים את הנוסחה: זה מה שעשיתי >> זה מה שהם מחפשים >> זאת הסיבה שאני בול לתפקיד.',
    ],
    donts: [
      'אם עשיתם משהו אבל הוא לא כתוב בקורות החיים — מבחינת המגייס לא עשיתם אותו.',
      'אל תשאירו את הניסיון הכי רלוונטי קבור בתפקיד מלפני 10 שנים ותצפו שמישהו יגיע אליו.',
      'אל תסמכו על "אם היא תקרא לעומק, היא תבין" — ברוב המקרים אף אחד לא קורא לעומק, ומערכת ATS סורקת את הקובץ לפני שמישהו בכלל רואה אותו.',
      'אל תשאירו טייטל גנרי שלא אומר למגייסת שאתם מתאימים לתפקיד הספציפי.',
      'אל תסתמכו על כך שתסבירו בעל פה למה אתם מתאימים — יכול להיות שלא תגיעו לשלב הזה בכלל.',
      'אל תניחו שהקורא ינחש את הקשר בין הניסיון שלכם לדרישות המשרה — תכתבו אותו במפורש.',
    ],
  ...
  progress: {
    title: '📊 ההתקדמות שלכם',
    lead: 'איפה אתם בכל אזור, ומה הדבר האחד שכדאי לעשות עכשיו.',
    nextEyebrow: 'מה הלאה',
    nextCta: 'התחילו',
    allDoneTitle: 'סיימתם את כל האזורים',
    allDoneMeta: 'חזרו לכל מדור כדי לרענן את החומר לפני ראיון.',
    steps: {
      lecture: { title: 'צפו בהרצאה', meta: 'כעשר דקות. בלי שום הגדרה מראש.' },
      challenge: {
        title: 'פתרו אתגר קוד',
        meta: 'נפתר כאן בדפדפן. בלי שום הגדרה מראש.',
      },
      resume: { title: 'בדקו את קורות החיים', meta: 'הדביקו את ה-CV. צורך בקשת AI אחת.' },
      interview: {
        title: 'הריצו ראיון סימולציה',
        meta: 'חמש שאלות בזמן אמת. צורך מהמכסה היומית שלכם.',
      },
    },
    badgesEarned: 'הושגו',
    storedLocal: 'נשמר בדפדפן הזה.',
    storedSynced: 'נשמר לחשבון שלכם.',
    signInHint: 'היכנסו כדי לשמור בין המכשירים שלכם.',
    overallLabel: 'סה"כ',
    lecturesLabel: 'הרצאות שנצפו',
    challengesLabel: 'אתגרי קוד שהושלמו',
    interviewLabel: 'ראיון סימולציה',
    resumeLabel: 'בדיקת קורות חיים',
    notStarted: 'לא התחיל',
    started: 'בתהליך',
    doneLabel: 'הושלם',
    badgesTitle: '🏅 הישגים',
    badges: {
      firstLecture: { label: 'חוקר הרצאות', desc: 'פתחו את ההרצאה הראשונה שלכם' },
      allLectures: { label: 'בוגר הסדרה', desc: 'צפו בכל ההרצאות הפעילות' },
      firstChallenge: { label: 'לוחם קוד', desc: 'פתרו את אתגר הקוד הראשון שלכם' },
      allChallenges: { label: 'אלוף הקוד', desc: 'פתרו את כל אתגרי הקוד' },
      interview: { label: 'מוכנים לראיון', desc: 'השלימו ראיון סימולציה' },
      resume: { label: 'קורות חיים מלוטשים', desc: 'קבלו בדיקת קורות חיים' },
      allRounder: { label: 'כוכב כולל', desc: 'השלימו את כל אזורי האקדמיה' },
    },
  },
  whatsNew: {
    title: '✨ מה חדש',
    items: [
      {
        title: '4 הרצאות AI Testing חדשות נוספו',
        desc: 'אבטחה, ביצועים, יצירת בדיקות בעזרת AI, ובניית אסטרטגיית בדיקות AI מלאה — הרצאות 7 עד 10 עלו לאוויר.',
        href: '#lecture-series',
        cta: 'עברו לסדרת ההרצאות ←',
      },
    ],
  },
  s: {
