export const en = {
  ...
  setup: {
    ...
    lead: 'The academy runs on a free, fast Groq default — no setup needed. Bring your own Claude or OpenAI key any time for a different model.',
    ...
    notice:
      "Your own key is kept only for this browser session unless you explicitly choose to remember it, and is sent directly to the provider's API. If you use the default key, requests are proxied through our server — the key itself never reaches your browser. Live search enrichment in the Practice Library always uses Google Search separately from this setting.",
    providers: [
  ...
  s: {
    ...
    errGroqKeyHint: ' (Groq keys start with gsk_ — get one free at console.groq.com/keys)',
