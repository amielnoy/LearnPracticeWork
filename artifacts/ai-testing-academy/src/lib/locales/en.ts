export const en = {
  ...
  hero: {
    ...
    cta: [
      { href: '#interview-talk', label: 'Try a sample interview →', cls: 'primary', sampleResume: false, sampleInterview: true },
      { href: '#resume', label: 'Analyze a sample CV', cls: 'ghost', sampleResume: true, sampleInterview: false },
      { href: '#lecture-series', label: 'Watch Lectures', cls: 'ghost', sampleResume: false, sampleInterview: false },
    ],
    tldr: {
  ...
  setup: {
    ...
    rememberKeyWarning: 'Only enable this on a private device. The key will remain in browser storage after you close this tab.',
    apiKeyLabel: 'API Key',
    resetBtn: '🔄 Reset provider settings',
    notice: "Your own key is kept only for this browser session unless you explicitly choose to remember it, and is sent directly to the provider's API. If you use the default key, requests are proxied through our server — the key itself never reaches your browser.",
    providers: [
  ...
  interview: {
    ...
    notice: 'Free AI usage starts automatically. If it is unavailable or exhausted, open Settings to connect your own provider.',
  ...
  s: {
    ...
    errNoKeyInterview: 'Free AI access is unavailable. Add your API key in Settings, then start the interview.',
    ...
    errVoiceNotSupported: 'Voice mode requires a browser that supports the Web Speech API (Chrome/Edge recommended).',
  },
  codingChallenges: {
