...
export const EN_BANK: BankData = {
  ...
  enrichHint: 'Uses Gemini with live Google Search to pull the QA / AI-test-automation interview questions most searched in the last 3 months — each with a model answer. Free usage starts automatically; connect a Gemini key in Settings if needed.',
  enriching: '✨ Enriching…',
...
export const HE_BANK: BankData = {
  ...
  enrichHint: 'משתמש ב-Gemini עם חיפוש Google חי כדי להביא את שאלות הראיון (QA ואוטומציית בדיקות מבוססת AI) המחופשות ביותר ב-3 החודשים האחרונים — כל אחת עם תשובת מודל. השימוש החינמי מתחיל אוטומטית; במידת הצורך אפשר לחבר מפתח Gemini בהגדרות.',
  enriching: '✨ מעשיר…',
